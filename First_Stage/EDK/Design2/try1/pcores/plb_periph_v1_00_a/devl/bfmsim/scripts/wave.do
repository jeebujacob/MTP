...
add wave -noupdate -divider {plb_periph Peripheral Interface Signals}
...
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/ipif_IP2Bus_AddrAck
...
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/ipif_Bus2IP_Burst
add wave -noupdate -format Literal -radix decimal /bfm_system/my_core/my_core/uut/ipif_Bus2IP_BurstLength
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/ipif_Bus2IP_WrReq
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/ipif_Bus2IP_RdReq
...
add wave -noupdate -format Literal -radix decimal /bfm_system/my_core/my_core/uut/user_Bus2IP_BurstLength
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_IP2Bus_AddrAck
...
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/Bus2IP_CS
...
add wave -noupdate -format Literal -radix decimal /bfm_system/my_core/my_core/uut/user_logic_i/Bus2IP_BurstLength
...
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/mem_data_out
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/mem_address
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mem_select
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mem_read_enable
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/mem_ip2bus_data
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mem_read_ack_dly1
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mem_read_ack
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mem_write_ack
