...
//%% File Name		: system_64_word.v																		%%
//%% Title 		: SIRC Wrapper for 1024*1024 Matrix Multiplication															%%
...
module system #(
	...
	parameter INMEM_USER_BYTE_WIDTH = 8,
	parameter OUTMEM_USER_BYTE_WIDTH = 8,
	...
	//If this value is changed, reflect the changes in the input/output memory .xco and regenerate the core.
	parameter INMEM_USER_ADDRESS_WIDTH = 11,
	...
	simpleTestModuleOne #(
      ...
      .reset(userLogicReset),											//When this signal is asserted (it is synchronous to userInterfaceClk), the user's circuit should reset
		...
		.LED(LED),.led1(led1),.led2(led2),.led3(led3),.led4(led4),.led5(led5)
	);
endmodule